    ...
    <div className="flex flex-col items-center justify-center h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white">
      <div className="text-center p-8">
        <div className="flex items-center justify-center text-5xl font-bold mb-4">
          <span className="bg-indigo-600 text-white p-4 rounded-2xl mr-5">
        ...
        <button
          onClick={onEnter}
          className="bg-indigo-600 text-white font-bold py-4 px-10 rounded-lg text-lg hover:bg-indigo-500 transition-all duration-200 transform hover:scale-110 active:scale-100 focus:outline-none focus:ring-4 focus:ring-indigo-500/50"
        >
          Get Started
        </button>
      </div>
